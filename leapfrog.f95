module leapfrog
    ...
    !real, parameter :: m_ar = 6.6e-26, q_ar =
    ...
    subroutine simulate(q, m, dt, name)
        ...
        real :: q, m  !naboj a hmotnost elektronu
        real (kind = SELECTED_REAL_KIND(16)) :: tempEnergy
        character (len=*) :: name
        integer :: i
    ...
    function energy(v, m) result(energ)
        implicit none
        real :: v(3), m
        real (kind = SELECTED_REAL_KIND(16)) :: energ
